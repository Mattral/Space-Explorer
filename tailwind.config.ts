...
export default {
	...
	theme: {
		...
		extend: {
			...
			nasa: {
				cyan: 'hsl(var(--nasa-cyan))',
				gold: 'hsl(var(--nasa-gold))',
				red: 'hsl(var(--nasa-red))',
				green: 'hsl(var(--nasa-green))',
				panel: 'hsl(var(--nasa-panel))',
				'panel-border': 'hsl(var(--nasa-panel-border))',
				glow: 'hsl(var(--nasa-glow))',
			},
			signal: {
